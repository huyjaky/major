...
public class counterview extends JFrame {
    ...
    public void __init__ () {
        ...
        this.indanhsach = new JMenuItem("in danh sach"); this.indanhsach.addActionListener(action);
    ...
    public void tong() {
        this.label_tongbill.setText(this.modul.inhoadon());
        this.modul.gia_ca = 0d;
    }

    public void xoa_bill_monchinh(Double gia) {
        this.modul.xoa_don_monchinh(gia);
    }
}